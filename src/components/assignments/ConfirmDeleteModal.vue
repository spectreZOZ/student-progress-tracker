            ...
            >
              ...
              <div class="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
                ...
                <button
                  type="button"
                  @click="$emit('close')"
                  class="mt-3 inline-flex w-full justify-center rounded-md bg-neutral-100 dark:bg-white/10 px-3 py-2 text-sm font-semibold text-black dark:text-white shadow-sm ring-1 ring-inset ring-neutral-300 dark:ring-white/10 hover:bg-neutral-200 dark:hover:bg-white/20 sm:mt-0 sm:w-auto transition-colors"
                >
                  Cancel
                </button>
              </div>
